...
function ChatDisplay({ refreshChats, chat, setMainDisplay }) {
  ...
  return (
    <div className="min-[850px]:h-full w-full flex flex-col max-[850px]:flex-1 max-[850px]:overflow-y-scroll relative">
      ...
      <div className="flex justify-between items-center max-[850px]:py-0 px-5 py-2">
        <div className="flex justify-center items-center gap-2">
          {chat.image ? (
            <div className="relative flex align-middle justify-center items-center w-[64px] h-[64px]">
              ...
              <img
                ...
                src={chat.image}
                alt="profile picture"
                className="w-[53.5px] h-[53.5px] cursor-pointer rounded-full z-0"
              />
            </div>
          ) : chat.type === 'direct' ? (
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              className="fill-sky-500 w-16 cursor-pointer"
            >
              <path d="M12,19.2C9.5,19.2 7.29,17.92 6,16C6.03,14 10,12.9 12,12.9C14,12.9 17.97,14 18,16C16.71,17.92 14.5,19.2 12,19.2M12,5A3,3 0 0,1 15,8A3,3 0 0,1 12,11A3,3 0 0,1 9,8A3,3 0 0,1 12,5M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12C22,6.47 17.5,2 12,2Z" />
            </svg>
          ) : (
          ...
          <p className="text-3xl max-[850px]:text-2xl text-neutral-500 dark:text-neutral-300">
            {chat.name}
          </p>
        </div>
