function UserProfile({ close, profile }) {
  return (
    <>
      <div
        onClick={close}
        className="h-screen w-screen -translate-x-[50%] absolute z-30 bg-gray-400/30 appear-fast"
      ></div>
      <div className="absolute right-0 z-40 bg-slate-100 dark:bg-slate-900 border-r flex flex-col border-slate-200 dark:border-slate-700 w-[360px] h-full transition-all">
